...
The following components were refactored to extend `EngineComponent` and use the new logging system:

-   **`BtEngine`:** Implements `ILoggingEngine`, initializes the root logger, and manages logging configuration.
