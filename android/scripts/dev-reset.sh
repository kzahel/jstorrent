#!/usr/bin/env bash
#
# dev-reset.sh - Clear JSTorrent app data on a real device
#
# Usage:
#   ./dev-reset.sh <device>
#
...
usage() {
    echo "Usage: $0 <device>"
    echo ""
    echo "Clear JSTorrent app data (settings, cache, databases)"
    echo ""
    echo "Arguments:"
...
run_adb_command "$DEVICE_NAME" shell pm clear com.jstorrent.app
