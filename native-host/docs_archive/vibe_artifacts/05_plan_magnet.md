...
- Register URL handler (might need `Info.plist` changes in a bundled `.app` structure, or `lsregister`). _Note: macOS protocol handlers usually require an `.app` bundle._
