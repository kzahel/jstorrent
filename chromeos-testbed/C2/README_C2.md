...
│  │              │              │                      │    │
│  │ You read     │  .c2/output  │ writes output here   │    │
│  │ results      │◄─────────────│                      │    │
│  └──────────────┘              └──────────────────────┘    │
└─────────────────────────────────────────────────────────────┘
```
...
# Read the output
cat /mnt/chromeos/MyFiles/Downloads/WSC/.c2/output
```
...
| resolution | `python3 input.py resolution 1920 1080` | Set screen resolution for tap coordinates |
...
| Output file | `.c2/output` | `.c2/output` |
